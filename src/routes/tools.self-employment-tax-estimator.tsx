...
const COUNTRIES: Country[] = [
  {
    ...
    note: "Federal, single filer. State income tax and the 15.3% self-employment tax are added on top. Source: IRS Revenue Procedure 2025-32, tax year 2026.",
  },
  {
    ...
    extra: { label: "Class 4 NI", rate: 0.06 },
    note: "England/Wales/NI bands. Class 4 NI shown is the 6% main rate up to the upper profits limit (2% above it, not modelled here). Source: HMRC, tax year 2026/27.",
  },
  {
    code: "CA", label: "Canada", currency: "CAD",
    brackets: [
      { upto: 58523, rate: 0.145 }, { upto: 117045, rate: 0.205 },
      { upto: 181440, rate: 0.26 }, { upto: 258482, rate: 0.29 },
      { upto: Infinity, rate: 0.33 },
    ],
    extra: { label: "CPP (both halves)", rate: 0.119 },
    note: "Federal only. Provincial tax is added on top. CPP shown is the 11.9% self-employed rate up to the year's maximum pensionable earnings (CPP2's extra 8% above that isn't modelled here). Source: CRA, tax year 2026.",
  },
  {
    code: "AU", label: "Australia", currency: "AUD",
    brackets: [
      { upto: 18200, rate: 0 }, { upto: 45000, rate: 0.15 },
      { upto: 135000, rate: 0.30 }, { upto: 190000, rate: 0.37 },
      { upto: Infinity, rate: 0.45 },
    ],
    note: "Resident rates. Medicare Levy (~2%) applies on top above thresholds. The 16% second bracket dropped to 15% from 1 July 2026. Source: ATO, FY2026-27.",
  },
  {
    ...
    note: "New regime slabs. Doesn't model the Section 87A rebate, which brings tax to zero up to ₹12 lakh taxable income for most filers — so this will overstate tax below that level. Cess (4%) and surcharge may apply above it. Source: Income Tax Dept, Budget 2025, FY2025-26.",
  },
  {
    code: "PK", label: "Pakistan", currency: "PKR",
    brackets: [
      { upto: 600000, rate: 0 }, { upto: 1200000, rate: 0.01 },
      { upto: 2200000, rate: 0.11 }, { upto: 3200000, rate: 0.23 },
      { upto: 4100000, rate: 0.30 }, { upto: Infinity, rate: 0.35 },
    ],
    note: "Salaried slabs (a 9% surcharge applies above ₹10M taxable income, not modelled here) — freelancers often qualify for a 1% export services turnover tax instead; consult a CA. Source: FBR Circular 01 of 2025-26, tax year 2025-26.",
  },
];
